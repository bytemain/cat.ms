...
![打开 cmd](https://i.cat.ms/posts/why-do-we-need-to-configure-environment-variables/5ccafd6ee176b.png)

那电脑是怎么知道 cmd 在哪儿的呢？

![在Everything搜索cmd.exe](https://i.cat.ms/posts/why-do-we-need-to-configure-environment-variables/5ccafe08db5ec.png)
...
![我的环境变量](https://i.cat.ms/posts/why-do-we-need-to-configure-environment-variables/5ccb0002c8879.png)
...
![设置 CMDER_ROOT](https://i.cat.ms/posts/why-do-we-need-to-configure-environment-variables/5ccb026a1dbfb.png)

然后我想打开该路径，就可以使用该字段名啦：
![Snipaste_2019-05-02_22-47-37](https://i.cat.ms/posts/why-do-we-need-to-configure-environment-variables/5ccb03181acf3.png)
