...
![omencommandcenter](https://i.cat.ms/posts/mod-omencommandcenter-key/omencommandcenter.png)
...
解决方法就是修改注册表：
![修改注册表](https://i.cat.ms/posts/mod-omencommandcenter-key/modify-registry.png)
